      ...
      <div className="flex-1 ml-64">
        ...
        <header className="bg-surface shadow-sm border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Welcome back, {user?.fullName || 'Administrator'}</p>
            </div>
        ...
        <main className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-600 mt-1">{stats.examIneligible || 0} students below 75% attendance threshold</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-600 mt-1">Face recognition model updated successfully</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-600 mt-1">System ready for new student registrations</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-8 bg-surface rounded-xl shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-900">Today's Classes Overview</h3>
            ...
            <div className="p-6">
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-400">Create classes to see them here</p>
              </div>
            </div>
          </div>
        </main>
