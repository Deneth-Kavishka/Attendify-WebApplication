...
class SmartTrackWebSocketService extends EventEmitter {
  ...
  /**
   * Public method to broadcast to all clients (for routes.ts compatibility)
   */
  public broadcastToAllClients(data: any): void {
    this.broadcastToClients(data);
  }
}

export default SmartTrackWebSocketService;
export const smartTrackWebSocketService = new SmartTrackWebSocketService();
